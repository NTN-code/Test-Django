"""
Django settings for BelBook project.
...
SECRET_KEY = 'django-insecure-)#l7do7=_64*243r1axg&4rjn6h%x^z+x-!+lge+($8d9q^9n*'
...
WSGI_APPLICATION = 'BelBook.wsgi.application'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'upmedia/')
